/*! @maplibre/maplibre-gl-leaflet v0.1.4 — https://github.com/maplibre/maplibre-gl-leaflet
 * ISC License, (c) MapLibre contributors (and the mapbox-gl-leaflet authors it forked).
 * VENDORED VERBATIM below this banner: cdnjs (this app's one script CDN) does not
 * carry the package, so it ships same-origin instead of adding a second CDN host.
 * Do NOT hand-edit. To bump, re-fetch
 *   curl -s https://cdn.jsdelivr.net/npm/@maplibre/maplibre-gl-leaflet@<ver>/leaflet-maplibre-gl.js
 * keep the maplibre-gl.min.js pin in index.html inside the plugin's peer range,
 * and update this hash of the verbatim body (sha256 of everything after this
 * banner's closing line): 1e6cf8cb3eb5fd909879aa1bf36a383fb506c9a5b2dbbfababce65a294dd1fcb
 */
