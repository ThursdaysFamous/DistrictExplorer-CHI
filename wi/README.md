...
A single-file, dependency-light web app: one `index.html`, Leaflet for the map, no build step, no framework, no server-side code. Deploys as a static site to any static host (https://wi.chidistricts.com/ via GitHub Pages out of the box).
