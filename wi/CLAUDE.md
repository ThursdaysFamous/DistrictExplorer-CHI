...
- Layers: 17 registered (political 6, safety 2, schools 3, geography 6); `registerLayer(` floor 12. Debug namespace `window.WisconsinExplorer`.
- Scheduled workflows: `update-wi-congress-roster.yml` (Mon 13:30 UTC); `update-wi-legislature-roster.yml` (Tue 13:30 UTC); `update-wi-county-board-roster.yml` (Thu 14:30 UTC); `update-wi-circuit-court-roster.yml` (Wed 15:30 UTC); `update-wi-court-of-appeals-roster.yml` (Wed 16:30 UTC); `wi-validate-sources.yml` (1st of month 13:00 UTC).
