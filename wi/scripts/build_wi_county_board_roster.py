...
Thirty-four of Wisconsin's 72 counties publish a district-keyed member list; the
other 38 are recorded in the Data gaps panel and their cards keep linking the
county board rather than naming anybody. See the scraper's docstring for what
each of the other 38 actually publishes.
...
MIN_SEATS = 726        # 755 today (699 page-scraped + Milwaukee 18 + Racine 21 + Taylor 17)
