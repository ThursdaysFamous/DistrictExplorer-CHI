...
Fifty-four of Wisconsin's 72 counties have a district-keyed member list this
project can reach, by one of the routes the scraper's docstring sets out; the
other 18 are recorded in the Data gaps panel and their cards keep linking the
...
MIN_COUNTIES = 52      # 54 ship one (42 board pages + 2 county GIS layers + Fond du
...
MIN_SEATS = 1147       # 1220 today; the tolerance is the two largest boards
