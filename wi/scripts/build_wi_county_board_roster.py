...
this can read; the other 38 are recorded in the Data gaps panel and their
...
MIN_COUNTIES = 32      # 34 ship one (30 pages + Dodge's constituent directory + 2 county
                       # GIS layers + Taylor by document); tolerates two dark
MIN_SEATS = 720        # 752 today (663 page-scraped + Dodge 33 + Milwaukee 18 + Racine 21 + Taylor 17)
