...
MIN_COUNTIES = 32      # 34 ship one (30 pages + 2 county GIS layers + Taylor and La Crosse by document); tolerates two dark
MIN_SEATS = 720        # 749 today (663 page-scraped + Milwaukee 18 + Racine 21 + Taylor 17 + La Crosse 30)
