...
MIN_COUNTIES = 65      # 67 ship one (41 board pages + 3 county GIS layers + Fond du
                       ...
                       # + Forest's supervisors page + NINE by dated document);
                       # tolerates two dark
MIN_SEATS = 1433       # 1506 today; the tolerance is the two largest boards
