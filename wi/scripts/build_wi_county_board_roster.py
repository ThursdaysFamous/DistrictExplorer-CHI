...
Fifty-two of Wisconsin's 72 counties have a district-keyed member list this
project can reach, by one of the eight routes the scraper's docstring sets out;
the other 20 are recorded in the Data gaps panel and their cards keep linking
...
MIN_COUNTIES = 50      # 52 ship one (42 board pages + 2 county GIS layers + Fond du
...
MIN_SEATS = 1101       # 1174 today; the tolerance is the two largest boards
