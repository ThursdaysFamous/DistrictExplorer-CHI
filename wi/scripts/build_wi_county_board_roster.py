...
MIN_COUNTIES = 32      # 34 ship one (30 pages + 2 county GIS layers + Taylor by document + Adams by PDF); tolerates two dark
MIN_SEATS = 710        # 739 today (663 page-scraped + Milwaukee 18 + Racine 21 + Taylor 17 + Adams 20)
