...
const OFFLINE = ["county", "wi-circuit-court", "us-house", "school-district-unified", "wi-senate", "wi-assembly", "county-board"];
const EXPECT_DISTRICT = { "county": "Marathon County", "wi-circuit-court": "Marathon County Circuit Court", "us-house": "7", "school-district-unified": "Marathon City School District", "wi-senate": "29", "wi-assembly": "86", "county-board": "35" };
