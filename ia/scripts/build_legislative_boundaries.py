...
Usage:
    python3 ia/scripts/build_legislative_boundaries.py             # all three
    python3 ia/scripts/build_legislative_boundaries.py ia-senate   # one chamber
"""
...
LAYERS = {
    "us-house": {
        ...
        "simplify": "12%",
        "min_features": 4,   # 4 Iowa congressional districts
    },
    "ia-senate": {
        "layer": 1,
        ...
        "simplify": "10%",
        "min_features": 50,  # 50 Iowa Senate districts
    },
    "ia-house": {
        "layer": 2,
        ...
        "simplify": "9%",
        "min_features": 100,  # 100 Iowa House districts
    },
}
DEFAULT_TARGETS = ["us-house", "ia-senate", "ia-house"]  # all three — see docstring
