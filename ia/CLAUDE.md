...
- Ground truth: 42.04940,-92.90710 (downtown Marshalltown, Marshall County) → county Marshall County; us-house 4; ia-senate 26; ia-house 52. Negative point 43.65000,-93.37000 (inside Minnesota (near Albert Lea), north of the Iowa land border (~43.50) and inside permalink_gate's maxLat (43.70) so the point is still selectable).
- Layers: 4 registered (political 3, geography 1); `registerLayer(` floor 4. Debug namespace `window.IowaExplorer`.
