...
| Cook County GIS (`gis.cookcountyil.gov/traditional/rest/services`) | Cook County Commissioner district boundaries + live officeholder table (the County Board layer's Cook entry); the Clerk's library, fire-protection, and park tax-agency tilings (the Library / Fire Protection / Park District layers' Cook entries); the Clerk's current suburban voting precincts (`precinctHistorical` L0, the Voting Precinct layer's Cook entry) |
