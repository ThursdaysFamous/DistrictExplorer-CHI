...
| | County Board District | Your county-legislature seat, picked by county: Cook Commissioner district (live officeholder join, office pin), Will or DuPage County Board district (weekly-scraped rosters + DuPage's countywide Chair), Lake County Board district (member + contact carried on the county's own GIS), Kane County Board district (member names on the county's own GIS), Kendall County Board district (the 5 members incl. the Chairman with phone/email), or a McHenry County Board district (the district's 2 members plus the countywide-elected Board Chairman with phone/email) — both rosters verified against each county's own member directory |
