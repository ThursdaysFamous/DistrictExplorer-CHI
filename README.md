...
| | County Board District | Your county-legislature seat, picked by county: Cook Commissioner district (live officeholder join, office pin), Will or DuPage County Board district (weekly-scraped rosters + DuPage's countywide Chair), Lake County Board district (member + contact + office address live on the county's own GIS, with the Board Chair/Vice-Chair tag from a weekly scrape of the county's directory), Kane County Board district (member with party, office phone, email + the countywide-elected Board Chair, weekly-scraped from the county's own directory list), Kendall County Board district (the district's 5 members incl. the Chairman, each with phone/email and a link to their page on the county directory), or a McHenry County Board district (the district's 2 members plus the countywide-elected Board Chairman, each with phone/email and a link to their page on the county directory) — Kendall's and McHenry's rosters verified against each county's own member directory |
