...
```json
{
  ...
  "wisconsin": ["us-house", "wi-senate", "wi-assembly", "county", "school-district-secondary", "school-district-unified", "school-district-elementary", "county-subdivision", "municipality", "zip-code", "post-office"]
}
```
  ...
  "wisconsin": [
    {
      ...
      "kind": "no-source",
      "layer": "county",
      "summary": "County board districts aren't built for this instance yet; the County card names your county but no members.",
      "why": "This instance ships the layers a national publisher can answer. County board supervisory districts and rosters are a per-county build against each county's own published map and member list, and none has been built yet.",
      "blocker": "Recorded at the 2026-08 in-place import: unexamined rather than measured shut. No per-county build has been attempted, and the statewide routes (including whether the Legislature's LTSB open-data portal publishes supervisory districts for all 72 counties) have not been probed yet.",
      "wanted": "Any county's official supervisory-district map (GIS layer, vector PDF, or certified election results naming whole wards) plus its board roster page — one county is enough to start."
    }
  ]
}
```
