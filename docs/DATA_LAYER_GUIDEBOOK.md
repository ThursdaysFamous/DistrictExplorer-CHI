...
```json
{
  ...
  "wisconsin": ["us-house", "wi-senate", "wi-assembly", "wi-circuit-court", "wi-court-of-appeals", "county", "school-district-secondary", "school-district-unified", "school-district-elementary", "county-board", "county-subdivision", "ward", "municipality", "zip-code", "school-site", "library", "police-station", "fire-station", "post-office"]
}
```
...
Fleet totals: **Chicago 39 · NYC 27 · SF 16 · Wisconsin 19** layers.
...
- **`aldermanic-district` statewide** — dissolve LTSB wards on COUSUBFP+ALDERID
  (~893 districts, 166 municipalities); blockers: per-city completeness gate needed
  (14 municipalities mix '00' with real ids), Appleton wholly uncoded by Outagamie
  in both 2026 editions (city GIS route unverified), no statewide roster (7 of the
  10 biggest cities scrapeable — the confirmed phase-3 ambition is boundary + those
  seven rosters). The concept-matrix city-council cell carries the measurements.
