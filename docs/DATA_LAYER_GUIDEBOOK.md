...
```json
{
  "chicago": [
    ...
    },
    {
      ...
      "why": "The county publishes no district map, and its certified results show two precincts split between districts, so no arrangement of whole precincts can draw them.",
      ...
      "wanted": "Douglas County's seven board district boundaries as map data, or a description of where those two split precincts divide."
    },
    {
