...
```json
{
  "chicago": [
    ...
    },
    {
      ...
      "kind": "data-quality",
      "layer": "county-precinct",
      "summary": "St. Clair County precinct cards name your precinct and board district, but not where you vote.",
      "why": "The county lists polling places in groups written for people — “Belleville 9, 10, 12 & 16” — which can't be matched to single precincts without guessing.",
      ...
      "wanted": "Polling places listed one per precinct, or a polling place field on the county's precinct data."
    },
    {
