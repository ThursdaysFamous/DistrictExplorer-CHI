...
```json
{
  "chicago": [
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "fire-district",
      "summary": "Monroe County's fire districts aren't shown — the county's map labels them only by abbreviation, like MVFD, and nothing published spells those out.",
      "why": "No key anywhere matches the abbreviations to district names, and guessing which similarly-lettered district is meant would be worse than showing nothing.",
      ...
      "wanted": "A key matching Monroe's fire abbreviations to district names, or boundaries that carry the names. The shapes themselves are ready."
    },
    {
