...
```json
{
  "chicago": [
    ...
    },
    {
      ...
      "kind": "data-quality",
      "layer": "county-precinct",
      "summary": "Tazewell's six unanswered precincts now show a polling place from the Clerk's own listing — what remains is five precincts where the county's two surfaces name DIFFERENT buildings.",
      ...
      "wanted": "Confirmation from the Clerk's office of which source is current for the five disagreeing precincts — Pekin 05, Groveland 02 and 04, Washington 05 and 12 — and, upstream, facility ids that identify one building each so the county's own precinct and voting-location layers can agree without a supplement. The six unanswered precincts are shipped and no longer part of this gap."
    },
    {
