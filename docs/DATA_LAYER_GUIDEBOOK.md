...
Fleet totals: **Chicago 39 · NYC 27 · SF 16 · Wisconsin 26** layers.
...
- ~~**NG911 fire/law service boundaries**~~ **SHIPPED 2026-08-26**, the fourth
  ...
  prove the builder's drop-by-date rule). ONE MEASURED CANDIDATE REMAINS
  QUEUED: **EmergencyMedicalServicesBoundary** (layer 2, 2,477 polygons —
  the ambulance analog of the shipped tilings, same schema and dissolve).
