...
```json
{
  ...
  "wisconsin": ["us-house", "wi-senate", "wi-assembly", "wi-circuit-court", "county", "school-district-secondary", "school-district-unified", "school-district-elementary", "county-board", "county-subdivision", "ward", "municipality", "zip-code", "police-station", "fire-station", "post-office"]
}
```
...
Fleet totals: **Chicago 39 · NYC 27 · SF 16 · Wisconsin 16** layers.
