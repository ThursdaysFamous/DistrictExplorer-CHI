...
```json
{
  "chicago": [
    ...
    },
    {
      ...
      "kind": "data-quality",
      "layer": "county-precinct",
      "summary": "Four of the county's 60 precincts point at two buildings its polling list does not include.",
      "blocker": "Re-measured live 3 Aug 2026, and the previous entry was WRONG about which precinct. Coloma 9 resolves fine: it references facility 4, which the county publishes as Rock River Christian Center. The County Clerk confirmed that venue by e-mail the same day, and the layer already agreed with her, so nothing needed overriding — an override was written and then reverted rather than ship dead code for data that is already correct. The join is 56 of 60, not 55. The four that do not resolve are Sterling 9, Sterling 14 and Sterling 18 (all pointing at facility 22) and Prophetstown 1 (facility 26); neither facility appears in the 29 published voting locations. Because three of the four share one missing building, publishing those two records would close the whole gap.",
      "wanted": "The two missing voting locations, facility 22 (serving three Sterling precincts) and facility 26 (Prophetstown 1), added to the county's published polling list — or simply the two building names, which is all the card shows."
    },
    {
