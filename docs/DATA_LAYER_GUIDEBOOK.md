...
- **RESEARCH PASS 7 (2026-08-02) — the frontier REOPENED: twenty-five counties now adjoin
  ...
  **The pass-7 build-ready ledger** (the live work queue, recommended order):
  ...
  4. **The derivation tier** — ~~De Witt (precinct dissolve)~~ **SHIPPED 2026-08-02 as
     the 34th county**; Washington + Marshall + Mason (township dissolves) and Cass (VTD
     dissolve) remain (~52k).
