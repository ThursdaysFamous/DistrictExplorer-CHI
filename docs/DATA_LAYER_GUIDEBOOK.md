...
```json
{
  "chicago": [
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "county-board",
      "summary": "Jasper's board form, composition and precinct list are all published and now read — three districts built from whole townships plus four Wade precincts — and one line inside the city of Newton is the only thing still missing.",
      ...
      "wanted": "The City of Newton's three ward boundaries as data — or a georeferencing of the county's own fully-vector 2023 ward map, which is the same job build_stephenson_precincts.py does. That is the ONLY missing piece: with those three lines, Wade 1, 2 and 3 are known, Wade 4 is TIGER's Wade township minus TIGER's Newton place, and the county's published composition dissolves all three board districts from whole units. The form, the composition, the precinct list and the roster source are no longer wanted — the county publishes every one of them."
    },
    {
