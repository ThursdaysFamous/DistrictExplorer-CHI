...
```json
{
  ...
  "wisconsin": ["us-house", "wi-senate", "wi-assembly", "wi-circuit-court", "wi-court-of-appeals", "county", "school-district-secondary", "school-district-unified", "school-district-elementary", "county-board", "county-subdivision", "ward", "municipality", "zip-code", "police-station", "fire-station", "post-office"]
}
```
...
Fleet totals: **Chicago 39 · NYC 27 · SF 16 · Wisconsin 17** layers.
...
| School site points | SHIPPED `school-site` | SHIPPED `school-site` | SHIPPED `school-site` | NOT SHIPPED — no school-site point layer |
...
| Library points | SHIPPED `library` (CPL) | SHIPPED `library` (NYPL/BPL/QPL) | SHIPPED `library` (SFPL) | NOT SHIPPED — DPI's WI_Public_Libraries_and_Branches layer /6 (482 points with address, phone, website, director + system; verified 2026-08-25) is the route, ships per `docs/WI_PHASE2_PLAN.md` PR 8 — statewide, wider than any sibling's city-scoped library layer |
