...
| `county` | County | geography | Bespoke | pre-built (TIGERweb State_County, 72 — offline anchor) | `wi-county-clerks.json` (Blue Book × clerks' association cross-gated, 72/72, weekly CI; Milwaukee's statutory election-commission note) | — |
