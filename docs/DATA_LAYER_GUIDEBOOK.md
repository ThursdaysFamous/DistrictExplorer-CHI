...
```json
{
  "chicago": [
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "county-board",
      "summary": "Nothing is shown for Pulaski County's board — not districts, not commissioners.",
      "why": "The county's website cannot be reached from here at all, and no map data for the county exists anywhere public.",
