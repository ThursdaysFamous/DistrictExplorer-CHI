...
```json
{
  "chicago": [
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "county-board",
      "summary": "Five county boards name an address on their card and 49 name none \u2014 Cook, Lake and Coles give an office, Clark and White a mailing line.",
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "county-board",
      "summary": "Three frontier counties have working websites but no map data anyone has found; none has been asked directly yet.",
      ...
      "wanted": "MARION LEFT THIS RECORD on 2026-08-20 for one of its own \u2014 its returns route was measured and found insufficient, which is more than this record ever knew about it. For each of the remaining three: whether the county's board districts and voting precincts exist as map data, and where. Asking the three clerks is the next move, not more searching — Jefferson proved it takes one e-mail."
    },
    {
