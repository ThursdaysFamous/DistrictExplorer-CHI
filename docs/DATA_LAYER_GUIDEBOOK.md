...
> | **The pass-6 build-ready ledger** — ~~8 counties' municipal-officials sources~~ **SHIPPED 2026-08-01** (Grundy, Livingston, Logan, McLean's three ward cities, Sangamon, Madison, St. Clair, Rock Island — the roster grew 360 → 492 municipalities; McLean's county-wide Airtable route stays open, see its row); still open: 4 precinct counties + 3 polling/naming joins, 5 board-geometry builds, 2 fire tilings, ~20 verified city ward layers | nothing — every source verified live 2026-07-31 | **yes — the live work queue** |
...
- **VALIDATION + SOURCING PASS 6 (2026-07-31) — every county × concept cell walked against
  ...
  **Pontiac** 5 (2025-05), **Bloomington** 9 + **Le Roy** 4 + **Lexington** 3 (clerk GIS polygons; its member-name columns measured STALE 2026-08-01 on Le Roy 2/8 and Lexington 2/6 across the April 2025 election — join the shipped municipal-officials rosters instead, which come from the cities' own pages; only Bloomington's GIS names were current), **Lincoln** 4 (names 8/8 current; boundary created 2019 —
