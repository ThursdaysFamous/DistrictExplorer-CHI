...
```json
{
  "chicago": [
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "county-board",
      "summary": "Alexander County's board FORM is settled — a three-member Board of Commissioners, from the county's own minutes — and its roster is not: the county publishes two of the three and names no third.",
      ...
      "wanted": "ONE THING: the name of the third commissioner, or confirmation that the seat is vacant. The county's board page publishes two of three and its minutes stop in May 2024, so no published source names the third. The FORM is no longer wanted — the county's own minutes settle it as a three-member Board of Commissioners, corroborated by the census's non-township marker. With that one name Alexander ships on the County card the same afternoon: it needs no geometry, and its ten precincts show no sign of a split fabric."
    },
    {
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "county-board",
      "summary": "Cumberland County JOINED THE RING ON ITS PRECINCTS on 21 Aug 2026, and its BOARD DISTRICTS remain the gap: those districts SPLIT precincts, so no union of whole precincts can ever draw them and only the county's own boundary will. Its form and its roster are both published and read.",
      ...
      "wanted": "ONE THING, and it is unchanged by the join: Cumberland's three board district boundaries as data or as a map. The precinct route is measured shut twice over from the county's own certified returns (Central 6 + Eastern 5 + Western 3 against twelve precincts), so no reading of published returns will ever produce them. Nothing further is wanted on the board's FORM or its ROSTER — both are published and read above — and nothing on the precincts, which shipped on 2026-08-21."
    },
    {
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "county-board",
      "summary": "Fayette's own district map is a vector PDF this project can now read completely — and what it says is that the districts CUT THROUGH precincts, so no dissolve of the county's own fabric can draw them.",
      ...
      "wanted": "The board-district shapefile or GIS layer behind the county's own printout, from the county or its mapping vendor — that is the only thing that answers this now. Failing that, TWO specific written answers would do almost as well: where inside the AVENA 1 precinct the District 5 / District 3 line runs (the county's Elmo inset shows it exists but not in any form a machine can read), and which of the seven western precincts — Hurricane, So Hurricane, Shafter, Bear Grove, Seminary, Kaskaskia, Pope — sit in District 2 and which in District 6, since the published map never draws that boundary. Everything else on the map is already read: the other five districts' precinct membership, all 28 precinct names, and a fabric that matches the census 28/28."
    },
    {
    ...
    },
    {
      ...
      "kind": "data-quality",
      "layer": "ward",
      "summary": "Galesburg publishes its seven council wards as map data — with the sitting member on each — and its twenty voting precincts beside them, and none of it can ship, because the city sits in a county nothing county-keyed answers in.",
      ...
      "wanted": "Any county-keyed Knox layer makes Knox served and ships these wards — with their sitting members, which the city's own layer carries — in the same change. The live asks are both to the COUNTY CLERK, not to the city: the precinct membership of board districts 4 and 5, and geometry for the Clerk's own precincts. Galesburg's half of the county needs nothing further; it is published."
    },
    {
      ...
      "kind": "data-quality",
      "layer": "county-board",
      "summary": "Gallatin's five board members ride the County card, and three of the five have no published contact of any kind — the county prints a phone for two and an e-mail for none.",
      ...
      "wanted": "County-published phone numbers and e-mail addresses for the five board members — particularly the three who currently have none — in any text form. The county's current polling-place list paired with the eleven precinct names would separately fill the one field the precinct cards lack."
    },
    {
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "county-board",
      "summary": "Jasper's board composition is published and its city wards are drawable, but its precincts are WEDGES that each carry a slice of the city and a large rural share — and no published source draws the rural parts.",
      ...
      "wanted": "WADE TOWNSHIP'S FOUR PRECINCT BOUNDARIES IN FULL — the rural parts, not the city wards. The city halves are already solved: the county's vector ward map yields Ward 2 and Wards 1+3 as closed rings that georeference to TIGER's Newton place at a 13 m median, and CB 3 takes Wade 1 and 3 together so the line between them is never needed. What no published source draws is where Wade 1, 2 and 4 divide the 97% of the township outside Newton. A precinct shapefile answers it; so would any map that draws the whole township rather than the city inset. The composition, the roster source and the city geometry are all in hand and corroborated — the registration balance runs -8.4/-0.1/+8.6% across the three districts."
    },
    {
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "county-board",
      "summary": "Johnson County JOINED THE RING ON ITS PRECINCTS on 21 Aug 2026 without its website ever being read — its certified returns publish elsewhere. Its board is settled AT LARGE, so no district geometry exists to seek; what is still missing is the ROSTER, and the only county source for it is the blocked site.",
      ...
      "wanted": "ONE THING: a county-published list of Johnson's sitting commissioners. Not the form — it is settled AT LARGE from certified returns, twice now, so there is no board geometry to seek and none should be invented. Not the precincts — they shipped on 2026-08-21. A certified return names who WON a contest, never who holds the seat today, and a mid-term appointment appears in no return anywhere (the Scott reasoning), so this needs the county's own page or the Clerk, not another canvass."
    },
    {
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "county-board",
      "summary": "Knox's board is not shown, and the reason is now structural rather than arithmetic: the county has TWO election authorities. Districts 1-3 lie inside Galesburg, which publishes them as live data; districts 4-5 lie in the County Clerk's half, which publishes neither their precinct membership nor any precinct geometry.",
      ...
      "wanted": "TWO THINGS, both from the COUNTY CLERK rather than the city, because Galesburg's half is already published: (1) which of the Clerk's precincts make up District 4 and which make up District 5 — a precinct-to-district table, the adopted plan's written description, or a Statement of Votes Cast rather than the summary the vendor carries; and (2) geometry for those precincts, since the county re-precincted after the 2020 census and no dissolve of census voting districts can stand in for them. Districts 1, 2 and 3 need nothing: the City of Galesburg's own precinct layer carries a County Board District on every one of its twenty precincts."
    },
    {
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "county-board",
      "summary": "Lawrence County's board form and roster are settled — seven single-member districts, all seven members published — and the geometry is not: the county's GIS carries taxing districts and no board districts or precincts at all.",
      ...
      "wanted": "The seven board districts as map data, or a written description of which townships and part-townships make up each — the county publishes nine townships (Allison, Bond, Bridgeport, Christy, Denison, Lawrence, Lukin, Petty, Russell) against seven districts, so at least two districts must be built from parts and no published source says which. A voting-precinct layer would do as well if the districts are unions of whole precincts. The form and the roster are no longer wanted: the county publishes both."
    },
    {
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "county-board",
      "summary": "One unserved county is left here — Jackson — plus Warren, which shipped its board districts but still publishes no precinct boundaries. Neither has ever been asked directly.",
      ...
      "wanted": "MARION LEFT THIS RECORD on 2026-08-20 for one of its own — its returns route was measured and found insufficient, which is more than this record ever knew about it. WARREN LEFT THIS RECORD on 2026-08-21 by SHIPPING, and it never needed the letter this record prescribes — its own board page and precinct-map legend were reachable the whole time at the domain of its Clerk's e-mail. For each of the remaining two: whether the county's board districts and voting precincts exist as map data, and where. Asking the two clerks is the next move, not more searching — Jefferson proved it takes one e-mail. HANCOCK LEFT THIS RECORD on 2026-08-21, also by SHIPPING and also without the letter, and its route is the one worth copying. Its Clerk runs a RESULTS DATABASE at electionstats.hancockcounty-il.gov — the county's own, not a vendor's — and every contest page carries a PER-PRECINCT table, so each County Board district contest NAMES the precincts that voted in it instead of only counting them. Two witnesses per district, an exact 33-precinct partition and a 33/33 Jasper pass followed in one sitting. The lesson generalises past this county: when a county site offers ‘previous election results’, look for a per-precinct table before writing to anybody. THAT LEAVES JACKSON ALONE HERE, and Jackson is the one this record's prescription cannot help — it was measured on 2026-08-21 and its districts split three precincts, so no letter can produce a whole-precinct composition that does not exist. WARREN IS STILL LISTED IN THIS RECORD ON PURPOSE, and the reason is worth stating because the prose above could be read as retiring it outright: its BOARD DISTRICTS shipped on 2026-08-21, but this record covers board district OR precinct boundaries, and Warren publishes no precinct geometry — it dispatches county-board and not county-precinct. So the county left the board half of this record and remains in the precinct half. If Warren's precincts are ever measured or obtained, it should get its own precinct-geometry successor the way Edwards, Wabash, Massac and Saline did, and leave here entirely."
    },
    {
    ...
    },
    {
      ...
      "kind": "blocked",
      "layer": "county-board",
      "summary": "Perry County JOINED THE RING ON ITS PRECINCTS on 21 Aug 2026 without its website ever being read — its certified returns publish elsewhere. The site block itself is unchanged, and what it still costs is the ROSTER: the board is settled AT LARGE, so no district geometry exists to seek, and the only county source for the commissioners is the blocked site.",
      ...
      "wanted": "ONE THING: a county-published list of Perry's sitting commissioners — or the county's site readable by an automated client, which would supply it. Not the form, which its own certified 2026 General Primary settles as AT LARGE, and not the precincts, which shipped on 2026-08-21 from that same canvass. The Clerk's e-mail works."
    },
    {
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "county-board",
      "summary": "The largest unserved county on the frontier. Asked twice and answered twice — the site is vercounty.org and the election authority holds no shapefiles or GIS layers — and its own certified returns now prove two precincts are split between board districts, which closes the dissolve route too.",
    ...
    },
    {
      ...
      "kind": "no-source",
      "layer": "county-board",
      "summary": "Wayne publishes its whole board composition in text and the census fabric matches it 27/27 — the only thing standing between this county and a build is that the county's own plan is 51.8 points out of balance.",
      ...
      "wanted": "CONFIRMATION FROM THE COUNTY of its own seven district lists — that they are current and complete, and that Fairfield 1 and Fairfield 2 sit in District 7 as the certified 2026 primary indicates. That decision was taken deliberately over shipping on a recorded exception: a 51.8-point spread is better read as a sign that something neither published source reveals is wrong than as a plan to draw. An adopted map or a precinct shapefile would answer everything at once and is the better outcome. Everything else is in hand: the composition is published by the county and corroborated by its returns, and the census fabric matches it 27/27."
    },
    {
