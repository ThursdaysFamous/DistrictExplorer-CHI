...
**76 of 102 Illinois counties are served** — 63 through their own dispatch entries, 3 through a shipped judicial circuit, and 10 through the County card alone. 26 more are researched-but-unserved (every one carries a recorded gap saying why), leaving 0 unresearched.
...
## Researched frontier (26) — gap-recorded, not yet served
