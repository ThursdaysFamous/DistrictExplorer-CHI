...
- `school-board` (political) DONE — point-in-polygon against the locally-hosted converted GeoJSON above. No roster source exists for this newly-elected body (not in open data, not covered by congress-legislators or Open States), so this links to CPS's official Board of Education page rather than guessing at contact info.
