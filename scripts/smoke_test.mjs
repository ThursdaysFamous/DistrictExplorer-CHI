...
const EXPECT_LAYERS = 40; // 18 base + police-beat (#43) + school-site (#45) + ccpsa-district-council + ward-precinct + 6 statewide local-gov layers (county, township, municipality, school districts x3 — TIGERweb) + 5 Will County layers (board, judicial, fire, park, precinct — coverage-gated) + 4 DuPage County layers (board, park, fire, special-police — coverage-gated) + 3 amenity nearest-point layers (post-office, library, early-voting) = 40 — live-verified 2026-07
