...
const EXPECT_LAYERS = 41; // 18 base + police-beat (#43) + school-site (#45) + ccpsa-district-council + ward-precinct + 6 statewide local-gov layers (county, township, municipality, school districts x3 — TIGERweb) + 5 Will County layers (board, judicial, fire, park, precinct — coverage-gated) + 5 DuPage County layers (board, judicial, park, fire, special-police — coverage-gated) + 3 amenity nearest-point layers (post-office, library, early-voting) = 41 — live-verified 2026-07
